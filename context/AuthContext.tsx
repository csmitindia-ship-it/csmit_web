...
interface AuthContextType {
  user: { id: number | null; email: string; role: 'admin' | 'student' | 'organizer' | null; name?: string } | null;
  login: (id: number | null, email: string, role: 'admin' | 'student' | 'organizer', name?: string) => void;
  logout: () => void;
  loading: boolean;
  isLoggedIn: boolean;
}
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  const [user, setUser] = useState<{ id: number | null; email: string; role: 'admin' | 'student' | 'organizer' | null; name?: string } | null>(() => {
  ...
  const login = (id: number | null, email: string, role: 'admin' | 'student' | 'organizer', name?: string) => {
